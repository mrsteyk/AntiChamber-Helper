...
public:
	...
	{
		std::wstring name = Name.GetWideName();
		if (Name.Number > 0)
		{
	...
	std::wstring GetFullWideName() const;
	...
	{
		return GetVFunction<void(__thiscall *)(UObject*, class UFunction*, void*, void*)>(this, 66)(this, function, parms, NULL);
	}
	...
	struct FRotator RSmerp(const struct FRotator& A, const struct FRotator& B, float Alpha, bool bShortestPath);
	...
	struct FVector VSmerp(const struct FVector& A, const struct FVector& B, float Alpha);
...
public:
	...
	char                                               UnknownData01[0x3A];                                      // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
{
public:
	class UClass*                                      SupportedClass;                                           // 0x003C(0x0004)
	class UClass*                                      ContextClass;                                             // 0x0040(0x0004)
	struct FString                                     Description;                                              // 0x0044(0x000C) (NeedCtorLink)
	TArray<struct FString>                             Formats;                                                  // 0x0050(0x000C) (NeedCtorLink)
	unsigned long                                      bCreateNew : 1;                                           // 0x005C(0x0004)
	unsigned long                                      bEditAfterNew : 1;                                        // 0x005C(0x0004)
	unsigned long                                      bEditorImport : 1;                                        // 0x005C(0x0004)
	unsigned long                                      bText : 1;                                                // 0x005C(0x0004)
	int                                                AutoPriority;                                             // 0x0060(0x0004)
	TArray<struct FString>                             ValidGameNames;                                           // 0x0064(0x000C) (NeedCtorLink)
...
{
public:
	char                                               UnknownData00[0x60];                                      // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	class UObject*                                     ClassDefaultObject;                                       // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	char                                               UnknownData01[0x5C];                                      // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
