...
struct FPlaylist
{
	...
	unsigned long                                      bIsArbitrated : 1;                                        // 0x0050(0x0004)
	unsigned long                                      bDisableDedicatedServerSearches : 1;                      // 0x0050(0x0004)
	TArray<struct FName>                               MapCycle;                                                 // 0x0054(0x000C) (NeedCtorLink)
	TArray<struct FInventorySwap>                      InventorySwaps;                                           // 0x0060(0x000C) (NeedCtorLink)
};
