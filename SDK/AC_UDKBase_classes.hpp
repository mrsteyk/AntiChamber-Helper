...
// 0x00C8 (0x045C - 0x0394)
class AUDKBot : public AAIController
{
public:
	class AUDKSquadAI*                                 Squad;                                                    // 0x0394(0x0004)
	class UUDKAIDecisionComponent*                     DecisionComponent;                                        // 0x0398(0x0004) (ExportObject, Component, EditInline)
	class AActor*                                      TemporaryFocus;                                           // 0x039C(0x0004)
	unsigned long                                      bExecutingWhatToDoNext : 1;                               // 0x03A0(0x0004)
	unsigned long                                      bScriptSpecialJumpCost : 1;                               // 0x03A0(0x0004)
	unsigned long                                      bForceRefreshRoute : 1;                                   // 0x03A0(0x0004)
	unsigned long                                      bTargetAlternateLoc : 1;                                  // 0x03A0(0x0004)
	unsigned long                                      bEnemyInfoValid : 1;                                      // 0x03A0(0x0004)
	unsigned long                                      bEnemyIsVisible : 1;                                      // 0x03A0(0x0004)
	unsigned long                                      bLeadTarget : 1;                                          // 0x03A0(0x0004)
	unsigned long                                      bJumpOverWall : 1;                                        // 0x03A0(0x0004)
	unsigned long                                      bPlannedJump : 1;                                         // 0x03A0(0x0004)
	unsigned long                                      bInDodgeMove : 1;                                         // 0x03A0(0x0004)
	unsigned long                                      bEnemyAcquired : 1;                                       // 0x03A0(0x0004)
	unsigned long                                      bNeedDelayedLeaveVehicle : 1;                             // 0x03A0(0x0004)
	unsigned long                                      bAllowRouteReuse : 1;                                     // 0x03A0(0x0004)
	unsigned long                                      bUsingSquadRoute : 1;                                     // 0x03A0(0x0004)
	unsigned long                                      bUsePreviousSquadRoute : 1;                               // 0x03A0(0x0004)
	unsigned char                                      ScriptedFireMode;                                         // 0x03A4(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03A5(0x0003) MISSED OFFSET
	float                                              EnemyVisibilityTime;                                      // 0x03A8(0x0004)
	class APawn*                                       VisibleEnemy;                                             // 0x03AC(0x0004)
	class AVehicle*                                    LastBlockingVehicle;                                      // 0x03B0(0x0004)
	class APawn*                                       CurrentlyTrackedEnemy;                                    // 0x03B4(0x0004)
	TArray<struct FEnemyPosition>                      SavedPositions;                                           // 0x03B8(0x000C) (NeedCtorLink)
	struct FVector                                     ImpactVelocity;                                           // 0x03C4(0x000C)
	int                                                AcquisitionYawRate;                                       // 0x03D0(0x0004)
	float                                              HearingThreshold;                                         // 0x03D4(0x0004)
	float                                              RespawnPredictionTime;                                    // 0x03D8(0x0004)
	float                                              WarningDelay;                                             // 0x03DC(0x0004)
	class AProjectile*                                 WarningProjectile;                                        // 0x03E0(0x0004)
	struct FVector                                     MonitorStartLoc;                                          // 0x03E4(0x000C)
	class APawn*                                       MonitoredPawn;                                            // 0x03F0(0x0004)
	float                                              MonitorMaxDistSq;                                         // 0x03F4(0x0004)
	struct FVector                                     LastSeenPos;                                              // 0x03F8(0x000C)
	struct FVector                                     LastSeeingPos;                                            // 0x0404(0x000C)
	float                                              LastSeenTime;                                             // 0x0410(0x0004)
	float                                              TrackingReactionTime;                                     // 0x0414(0x0004)
	float                                              BaseTrackingReactionTime;                                 // 0x0418(0x0004)
	struct FVector                                     TrackedVelocity;                                          // 0x041C(0x000C)
	class ANavigationPoint*                            SquadRouteGoal;                                           // 0x0428(0x0004)
	class APawn*                                       BlockedAimTarget;                                         // 0x042C(0x0004)
	float                                              LastIterativeCheck;                                       // 0x0430(0x0004)
	float                                              AimUpdateFrequency;                                       // 0x0434(0x0004)
	float                                              LastAimUpdateTime;                                        // 0x0438(0x0004)
	float                                              ErrorUpdateFrequency;                                     // 0x043C(0x0004)
	float                                              LastErrorUpdateTime;                                      // 0x0440(0x0004)
	float                                              CurrentAimError;                                          // 0x0444(0x0004)
	float                                              DodgeLandZ;                                               // 0x0448(0x0004)
	class AActor*                                      FearSpots[0x2];                                           // 0x044C(0x0004)
	float                                              DodgeToGoalPct;                                           // 0x0454(0x0004)
	float                                              MultiJumpZ;                                               // 0x0458(0x0004)
...
{
public:
	class ATeamInfo*                                   Team;                                                     // 0x01D4(0x0004) (Net, RepNotify)
	...
	unsigned long                                      bHome : 1;                                                // 0x01E4(0x0004) (Net, RepNotify)
...
{
public:
	class UUDKUIDataProvider_ServerDetails*            ServerDetailsProvider;                                    // 0x00A8(0x0004) (Transient)
...
{
public:
	TArray<struct FAttachedExplosionLight>             RelativeExplosionLights;                                  // 0x022C(0x000C) (Component, NeedCtorLink)
	...
	class UParticleSystemComponent* SpawnEmitter(class UParticleSystem* EmitterTemplate, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, class AActor* AttachToActor, bool bInheritScaleFromBase);
};
...
{
public:
	unsigned long                                      bCheckFrameRate : 1;                                      // 0x0238(0x0004)
	unsigned long                                      bInitialized : 1;                                         // 0x0238(0x0004)
	float                                              HighDetailFrameTime;                                      // 0x023C(0x0004)
	float                                              Lifetime;                                                 // 0x0240(0x0004)
	int                                                TimeShiftIndex;                                           // 0x0244(0x0004)
	TArray<struct FLightValues>                        TimeShift;                                                // 0x0248(0x000C) (Edit, NeedCtorLink)
	struct FScriptDelegate                             __OnLightFinished__Delegate;                              // 0x0254(0x000C) (NeedCtorLink)
...
{
public:
	int                                                BlockUIInputSemaphore;                                    // 0x015C(0x0004)
...
public:
	...
	unsigned long                                      bUnderAttack : 1;                                         // 0x02B8(0x0004) (Net, RepNotify)
	...
	unsigned char                                      DefenderTeamIndex;                                        // 0x02DC(0x0001) (Net, RepNotify)
...
public:
	...
	void TranslateBindToFont(const struct FString& InBindStr, class UFont** DrawFont, struct FString* OutBindStr);
...
public:
	...
	unsigned long                                      bBroken : 1;                                              // 0x02C8(0x0004) (RepNotify)
...
{
public:
	float                                              FOV;                                                      // 0x02D0(0x0004) (Const)
	unsigned long                                      bHasSavedScale3D : 1;                                     // 0x02D4(0x0004) (Const)
	struct FVector                                     SavedScale3D;                                             // 0x02D8(0x000C) (Const)
...
{
public:
	unsigned long                                      bReadyToDoubleJump : 1;                                   // 0x0460(0x0004)
	unsigned long                                      bRequiresDoubleJump : 1;                                  // 0x0460(0x0004)
	unsigned long                                      bCanDoubleJump : 1;                                       // 0x0460(0x0004)
	unsigned long                                      bNoJumpAdjust : 1;                                        // 0x0460(0x0004)
	unsigned long                                      bIsHoverboardAnimPawn : 1;                                // 0x0460(0x0004)
	unsigned long                                      bFeigningDeath : 1;                                       // 0x0460(0x0004) (Net, RepNotify)
	unsigned long                                      bNotifyStopFalling : 1;                                   // 0x0460(0x0004)
	unsigned long                                      bIsInvisible : 1;                                         // 0x0460(0x0004) (Net, RepNotify)
	unsigned long                                      bSmoothNetUpdates : 1;                                    // 0x0460(0x0004)
	unsigned long                                      bPuttingDownWeapon : 1;                                   // 0x0460(0x0004) (Net, RepNotify)
	unsigned long                                      bPlayingFeignDeathRecovery : 1;                           // 0x0460(0x0004)
	unsigned long                                      bCanPlayFallingImpacts : 1;                               // 0x0460(0x0004)
	unsigned long                                      bEnableFootPlacement : 1;                                 // 0x0460(0x0004)
	unsigned long                                      bPostRenderOtherTeam : 1;                                 // 0x0460(0x0004)
	unsigned long                                      bBlendOutTakeHitPhysics : 1;                              // 0x0460(0x0004)
	unsigned long                                      bUpdateEyeheight : 1;                                     // 0x0460(0x0004)
	unsigned long                                      bTearOffGibs : 1;                                         // 0x0460(0x0004) (Net)
	float                                              MaxDoubleJumpHeight;                                      // 0x0464(0x0004)
	int                                                MultiJumpRemaining;                                       // 0x0468(0x0004)
	int                                                MaxMultiJump;                                             // 0x046C(0x0004)
	int                                                MultiJumpBoost;                                           // 0x0470(0x0004)
	float                                              CustomGravityScaling;                                     // 0x0474(0x0004) (Net)
	struct FPlayEmoteInfo                              EmoteRepInfo;                                             // 0x0478(0x0010) (Net, RepNotify)
	float                                              LastEmoteTime;                                            // 0x0488(0x0004)
	float                                              MinTimeBetweenEmotes;                                     // 0x048C(0x0004)
	unsigned char                                      BigTeleportCount;                                         // 0x0490(0x0001) (Net, RepNotify)
	unsigned char                                      WeaponOverlayFlags;                                       // 0x0491(0x0001) (Net, RepNotify)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0492(0x0002) MISSED OFFSET
	struct FUTTakeHitInfo                              LastTakeHitInfo;                                          // 0x0494(0x0028) (Net, RepNotify)
	float                                              LastTakeHitTimeout;                                       // 0x04BC(0x0004)
	float                                              FireRateMultiplier;                                       // 0x04C0(0x0004) (Net, RepNotify)
	float                                              HeadScale;                                                // 0x04C4(0x0004) (Net, RepNotify)
	float                                              MaxSmoothNetUpdateDist;                                   // 0x04C8(0x0004)
	float                                              NoSmoothNetUpdateDist;                                    // 0x04CC(0x0004)
	float                                              SmoothNetUpdateTime;                                      // 0x04D0(0x0004)
	struct FVector                                     MeshTranslationOffset;                                    // 0x04D4(0x000C)
	float                                              OldZ;                                                     // 0x04E0(0x0004)
	class UAudioComponent*                             PawnAmbientSound;                                         // 0x04E4(0x0004) (ExportObject, Component, EditInline)
	class USoundCue*                                   PawnAmbientSoundCue;                                      // 0x04E8(0x0004) (Net, RepNotify)
	struct FDrivenWeaponPawnInfo                       DrivenWeaponPawn;                                         // 0x04EC(0x000C) (Net, RepNotify)
	class UAudioComponent*                             WeaponAmbientSound;                                       // 0x04F8(0x0004) (ExportObject, Component, EditInline)
	class USoundCue*                                   WeaponAmbientSoundCue;                                    // 0x04FC(0x0004) (Net, RepNotify)
	class UMaterial*                                   ReplicatedBodyMaterial;                                   // 0x0500(0x0004) (Net, RepNotify)
	TArray<class UMaterialInstanceConstant*>           BodyMaterialInstances;                                    // 0x0504(0x000C) (NeedCtorLink)
	class UMaterialInterface*                          OverlayMaterialInstance;                                  // 0x0510(0x0004) (Net, RepNotify)
	class USkelControlSingleBone*                      RootRotControl;                                           // 0x0514(0x0004)
	class UAnimNodeAimOffset*                          AimNode;                                                  // 0x0518(0x0004)
	class UGameSkelCtrl_Recoil*                        GunRecoilNode;                                            // 0x051C(0x0004)
	class UGameSkelCtrl_Recoil*                        LeftRecoilNode;                                           // 0x0520(0x0004)
	class UGameSkelCtrl_Recoil*                        RightRecoilNode;                                          // 0x0524(0x0004)
	TArray<class AUDKBot*>                             Trackers;                                                 // 0x0528(0x000C) (NeedCtorLink)
	float                                              BodyMatFadeDuration;                                      // 0x0534(0x0004)
	struct FLinearColor                                CurrentBodyMatColor;                                      // 0x0538(0x0010)
	float                                              RemainingBodyMatDuration;                                 // 0x0548(0x0004)
	float                                              ClientBodyMatDuration;                                    // 0x054C(0x0004) (Net, RepNotify)
	struct FLinearColor                                BodyMatColor;                                             // 0x0550(0x0010)
	struct FRotator                                    CompressedBodyMatColor;                                   // 0x0560(0x000C) (Net, RepNotify)
	float                                              StartFallImpactTime;                                      // 0x056C(0x0004)
	struct FName                                       TorsoBoneName;                                            // 0x0570(0x0008)
	class USoundCue*                                   FallImpactSound;                                          // 0x0578(0x0004)
	float                                              FallSpeedThreshold;                                       // 0x057C(0x0004)
	class UStaticMeshComponent*                        BlobShadow;                                               // 0x0580(0x0004) (ExportObject, Component, EditInline)
	class USkeletalMeshComponent*                      OverlayMesh;                                              // 0x0584(0x0004) (ExportObject, Component, EditInline)
	struct FName                                       LeftFootBone;                                             // 0x0588(0x0008)
	struct FName                                       RightFootBone;                                            // 0x0590(0x0008)
	struct FName                                       LeftFootControlName;                                      // 0x0598(0x0008)
	struct FName                                       RightFootControlName;                                     // 0x05A0(0x0008)
	float                                              BaseTranslationOffset;                                    // 0x05A8(0x0004)
	float                                              CrouchTranslationOffset;                                  // 0x05AC(0x0004)
	float                                              OldLocationZ;                                             // 0x05B0(0x0004)
	float                                              ZSmoothingRate;                                           // 0x05B4(0x0004) (Const)
	float                                              MaxFootPlacementDistSquared;                              // 0x05B8(0x0004)
	class USkelControlFootPlacement*                   LeftLegControl;                                           // 0x05BC(0x0004)
	class USkelControlFootPlacement*                   RightLegControl;                                          // 0x05C0(0x0004)
	class USkelControlLimb*                            LeftHandIK;                                               // 0x05C4(0x0004)
	class USkelControlLimb*                            RightHandIK;                                              // 0x05C8(0x0004)
	struct FName                                       DamageParameterName;                                      // 0x05CC(0x0008)
	struct FName                                       SaturationParameterName;                                  // 0x05D4(0x0008)
	float                                              LastPostRenderTraceTime;                                  // 0x05DC(0x0004)
	float                                              TeamBeaconMaxDist;                                        // 0x05E0(0x0004) (Edit)
	float                                              StartedFallingTime;                                       // 0x05E4(0x0004)
	float                                              SlopeBoostFriction;                                       // 0x05E8(0x0004)
	class UAnimNodeAimOffset*                          FlyingDirOffset;                                          // 0x05EC(0x0004)
	int                                                MaxLeanRoll;                                              // 0x05F0(0x0004)
	float                                              FeignDeathPhysicsBlendOutSpeed;                           // 0x05F4(0x0004)
	float                                              SwimmingZOffset;                                          // 0x05F8(0x0004) (Edit)
	float                                              SwimmingZOffsetSpeed;                                     // 0x05FC(0x0004) (Edit)
	float                                              CrouchMeshZOffset;                                        // 0x0600(0x0004)
	float                                              TakeHitPhysicsBlendOutSpeed;                              // 0x0604(0x0004)
	class UUDKSkeletalMeshComponent*                   ArmsMesh[0x2];                                            // 0x0608(0x0004) (ExportObject, Component, EditInline)
	int                                                RootYaw;                                                  // 0x0610(0x0004)
	float                                              RootYawSpeed;                                             // 0x0614(0x0004)
	int                                                MaxYawAim;                                                // 0x0618(0x0004) (Edit)
	struct FVector2D                                   CurrentSkelAim;                                           // 0x061C(0x0008)
	struct FVector                                     HUDLocation;                                              // 0x0624(0x000C)
...
{
public:
	unsigned long                                      bIsRespawning : 1;                                        // 0x02C8(0x0004) (Net, RepNotify)
	unsigned long                                      bPulseBase : 1;                                           // 0x02C8(0x0004) (Net, RepNotify)
	unsigned long                                      bIsDisabled : 1;                                          // 0x02C8(0x0004) (Net, RepNotify)
...
// 0x01F8 (0x07B4 - 0x05BC)
class AUDKPlayerController : public AGamePlayerController
{
public:
	class UCameraAnimInst*                             CameraAnimPlayer;                                         // 0x05BC(0x0004)
	class AUDKEmitCameraEffect*                        CameraEffect;                                             // 0x05C0(0x0004)
	unsigned long                                      bDedicatedServerSpectator : 1;                            // 0x05C4(0x0004)
	unsigned long                                      bAcuteHearing : 1;                                        // 0x05C4(0x0004)
	unsigned long                                      bConsolePlayer : 1;                                       // 0x05C4(0x0004)
	unsigned long                                      bPulseTeamColor : 1;                                      // 0x05C4(0x0004)
	unsigned long                                      bUsePhysicsRotation : 1;                                  // 0x05C4(0x0004)
	struct FVector                                     ShakeOffset;                                              // 0x05C8(0x000C)
	struct FRotator                                    ShakeRot;                                                 // 0x05D4(0x000C)
	struct FPostProcessSettings                        CamOverridePostProcess;                                   // 0x05E0(0x00E0) (NeedCtorLink)
	struct FPostProcessSettings                        PostProcessModifier;                                      // 0x06C0(0x00E0) (NeedCtorLink)
	TArray<class AActor*>                              PotentiallyHiddenActors;                                  // 0x07A0(0x000C) (NeedCtorLink)
	float                                              VehicleCheckRadiusScaling;                                // 0x07AC(0x0004)
	float                                              PulseTimer;                                               // 0x07B0(0x0004)
...
// 0x0014 (0x04FC - 0x04E8)
class AUDKScout : public AScout
{
public:
	unsigned long                                      bRequiresDoubleJump : 1;                                  // 0x04E8(0x0004)
	float                                              MaxDoubleJumpHeight;                                      // 0x04EC(0x0004)
	class UClass*                                      PrototypePawnClass;                                       // 0x04F0(0x0004)
	struct FName                                       SizePersonFindName;                                       // 0x04F4(0x0008)
...
// 0x000F (0x05E4 - 0x05D5)
class UUDKSkeletalMeshComponent : public USkeletalMeshComponent
{
public:
	unsigned char                                      UnknownData00[0x3];                                       // 0x05D5(0x0003) MISSED OFFSET
	float                                              FOV;                                                      // 0x05D8(0x0004) (Edit, Const)
	unsigned long                                      bForceLoadTextures : 1;                                   // 0x05DC(0x0004)
	float                                              ClearStreamingTime;                                       // 0x05E0(0x0004)
...
{
public:
	unsigned char                                      TeamNumber;                                               // 0x02B4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x02B5(0x0003) MISSED OFFSET
	TArray<class UTexture2D*>                          TeamSprites;                                              // 0x02B8(0x000C) (NeedCtorLink, EditorOnly)
...
{
public:
	struct FName                                       PlayerRatioTag;                                           // 0x0090(0x0008) (Const)
	struct FName                                       GameModeFriendlyNameTag;                                  // 0x0098(0x0008) (Const)
	struct FName                                       ServerFlagsTag;                                           // 0x00A0(0x0008) (Const)
	struct FName                                       MapNameTag;                                               // 0x00A8(0x0008) (Const)
	struct FString                                     IconFontPathName;                                         // 0x00B0(0x000C) (Const, NeedCtorLink)
...
{
public:
	int                                                SearchResultsRow;                                         // 0x005C(0x0004) (Transient)
...
public:
	...
	class UClass*                                      MapInfoDataProviderClass;                                 // 0x00C8(0x0004)
	TArray<int>                                        EnabledMutators;                                          // 0x00CC(0x000C) (NeedCtorLink)
	TArray<int>                                        MapCycle;                                                 // 0x00D8(0x000C) (NeedCtorLink)
	TArray<int>                                        WeaponPriority;                                           // 0x00E4(0x000C) (NeedCtorLink)
	int                                                GameModeFilter;                                           // 0x00F0(0x0004)
	...
	bool GetValueFromProviderSet(const struct FName& ProviderFieldName, const struct FName& SearchTag, int ListIndex, struct FString* OutValue);
	int FindValueInProviderSet(const struct FName& ProviderFieldName, const struct FName& SearchTag, const struct FString& SearchValue);
	void GetAllResourceDataProviders(class UClass* ProviderClass, TArray<class UUDKUIResourceDataProvider*>* Providers);
	bool IsProviderFiltered(const struct FName& FieldName, int ProviderIdx);
	int GetProviderCount(const struct FName& FieldName);
};
...
{
public:
	struct FMultiMap_Mirror                            OptionProviders;                                          // 0x00C4(0x003C) (Const, Native, Transient)
	TArray<class UUDKUIResourceDataProvider*>          DynamicProviders;                                         // 0x0100(0x000C) (Transient, NeedCtorLink)
	...
	void GetSet(const struct FName& SetName, TArray<class UUDKUIResourceDataProvider*>* OutProviders);
	void AppendToSet(const struct FName& SetName, int NumOptions);
	void ClearSet(const struct FName& SetName);
};
...
public:
	...
	struct FMap_Mirror                                 CommandToBindNames;                                       // 0x00C8(0x003C) (Const, Native, Transient)
	TArray<struct FControllerMap>                      ControllerMapArray;                                       // 0x0104(0x000C) (Config, NeedCtorLink)
...
{
public:
	struct FString                                     FriendlyName;                                             // 0x007C(0x000C) (Const, Config, Localized, NeedCtorLink)
	unsigned long                                      bSearchAllInis : 1;                                       // 0x0088(0x0004) (Edit)
	unsigned long                                      bRemoveOn360 : 1;                                         // 0x0088(0x0004) (Config)
	unsigned long                                      bRemoveOnPC : 1;                                          // 0x0088(0x0004) (Config)
	unsigned long                                      bRemoveOnPS3 : 1;                                         // 0x0088(0x0004) (Config)
	struct FString                                     IniName;                                                  // 0x008C(0x000C) (Const, NeedCtorLink)
...
{
public:
	int                                                MapId;                                                    // 0x0098(0x0004) (Config)
	struct FString                                     MapName;                                                  // 0x009C(0x000C) (Config, NeedCtorLink)
	struct FString                                     NumPlayers;                                               // 0x00A8(0x000C) (Const, Config, Localized, NeedCtorLink)
	struct FString                                     Description;                                              // 0x00B4(0x000C) (Const, Config, Localized, NeedCtorLink)
	struct FString                                     PreviewImageMarkup;                                       // 0x00C0(0x000C) (Config, NeedCtorLink)
...
{
public:
	TEnumAsByte<EUTOptionType>                         OptionType;                                               // 0x0098(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	TArray<struct FName>                               OptionSet;                                                // 0x009C(0x000C) (Config, NeedCtorLink)
	struct FString                                     DataStoreMarkup;                                          // 0x00A8(0x000C) (Config, NeedCtorLink)
	struct FName                                       RequiredGameMode;                                         // 0x00B4(0x0008) (Config)
	struct FString                                     CustomFriendlyName;                                       // 0x00BC(0x000C) (NeedCtorLink)
	struct FString                                     Description;                                              // 0x00C8(0x000C) (Const, Config, Localized, NeedCtorLink)
	unsigned long                                      bEditableCombo : 1;                                       // 0x00D4(0x0004) (Config)
	unsigned long                                      bNumericCombo : 1;                                        // 0x00D4(0x0004) (Config)
	unsigned long                                      bKeyboardOrMouseOption : 1;                               // 0x00D4(0x0004) (Config)
	unsigned long                                      bOnlineOnly : 1;                                          // 0x00D4(0x0004) (Config)
	unsigned long                                      bOfflineOnly : 1;                                         // 0x00D4(0x0004) (Config)
	int                                                EditBoxMaxLength;                                         // 0x00D8(0x0004) (Config)
	struct FUIRangeData                                RangeData;                                                // 0x00DC(0x0014) (Config)
...
public:
	...
	unsigned long                                      bIsDisabled : 1;                                          // 0x05FC(0x0004) (Net, RepNotify)
	...
	unsigned long                                      bDeadVehicle : 1;                                         // 0x05FC(0x0004) (Net, RepNotify)
	...
	struct FRotator                                    WeaponRotation;                                           // 0x067C(0x000C) (Net, RepNotify)
	...
	unsigned char                                      Team;                                                     // 0x0770(0x0001) (Net, RepNotify)
...
{
public:
	class AUDKVehicle*                                 MyVehicle;                                                // 0x05FC(0x0004) (Net, RepNotify)
	class AUDKWeapon*                                  MyVehicleWeapon;                                          // 0x0600(0x0004) (Net, RepNotify)
	int                                                MySeatIndex;                                              // 0x0604(0x0004) (Net, RepNotify)
...
public:
	...
	int                                                AmmoCount;                                                // 0x02CC(0x0004) (Net, RepNotify)
	unsigned char                                      HitEnemy;                                                 // 0x02D0(0x0001) (Net, RepNotify)
...
{
public:
	struct FVector                                     WorldSpaceGoal;                                           // 0x0140(0x000C)
	struct FVector                                     InitialWorldSpaceGoalOffset;                              // 0x014C(0x000C) (Edit)
	struct FVector                                     Velocity;                                                 // 0x0158(0x000C)
	float                                              SpringStiffness;                                          // 0x0164(0x0004) (Edit)
	float                                              SpringDamping;                                            // 0x0168(0x0004) (Edit)
	float                                              PercentBeamVelocityTransfer;                              // 0x016C(0x0004) (Edit)
	struct FScriptDelegate                             __EntireBeamVelocity__Delegate;                           // 0x0170(0x000C) (NeedCtorLink)
...
{
public:
	unsigned long                                      bLimitYaw : 1;                                            // 0x0140(0x0004) (Edit)
	unsigned long                                      bLimitPitch : 1;                                          // 0x0140(0x0004) (Edit)
	unsigned long                                      bLimitRoll : 1;                                           // 0x0140(0x0004) (Edit)
	unsigned long                                      bShowPerAxisLimits : 1;                                   // 0x0140(0x0004) (Edit)
	float                                              YawLimit;                                                 // 0x0144(0x0004) (Edit)
	float                                              PitchLimit;                                               // 0x0148(0x0004) (Edit)
	float                                              RollLimit;                                                // 0x014C(0x0004) (Edit)
