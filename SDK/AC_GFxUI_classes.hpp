...
{
public:
	struct FPointer                                    VfTable_FCallbackEventDevice;                             // 0x006C(0x0004) (Const, Native, NoExport)
...
public:
	...
	unsigned char                                      UnknownData03[0x3C];                                      // 0x0128(0x003C) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	TArray<class UGFxObject*>                          ObjectValues;                                             // 0x0164(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x0170(0x000C) (NeedCtorLink)
...
public:
	...
	struct FString                                     SourceFile;                                               // 0x0070(0x000C) (Edit, NeedCtorLink, EditorOnly)
	...
	struct FString                                     SourceFileTimestamp;                                      // 0x0090(0x000C) (Edit, EditConst, NeedCtorLink, EditorOnly)
	int                                                RTTextures;                                               // 0x009C(0x0004)
	int                                                RTVideoTextures;                                          // 0x00A0(0x0004)
	struct FQWord                                      ImportTimeStamp;                                          // 0x00A4(0x0008) (Const, Transient, EditorOnly)
...
{
public:
	class UGFxMoviePlayer*                             Movie;                                                    // 0x00E8(0x0004)
	unsigned long                                      bUnload : 1;                                              // 0x00EC(0x0004) (Edit)
...
public:
	class UGFxMoviePlayer*                             Movie;                                                    // 0x00E8(0x0004)
	struct FString                                     Variable;                                                 // 0x00EC(0x000C) (Edit, NeedCtorLink)
...
public:
	class UGFxMoviePlayer*                             Movie;                                                    // 0x00E8(0x0004)
	struct FString                                     MethodName;                                               // 0x00EC(0x000C) (Edit, NeedCtorLink)
	TArray<struct FASValue>                            Arguments;                                                // 0x00F8(0x000C) (Edit, NeedCtorLink)
...
{
public:
	class USwfMovie*                                   Movie;                                                    // 0x00E8(0x0004) (Edit)
	class UClass*                                      MoviePlayerClass;                                         // 0x00EC(0x0004) (Edit)
	class UGFxMoviePlayer*                             MoviePlayer;                                              // 0x00F0(0x0004)
	unsigned long                                      bTakeFocus : 1;                                           // 0x00F4(0x0004) (Edit)
	unsigned long                                      bCaptureInput : 1;                                        // 0x00F4(0x0004) (Edit)
	unsigned long                                      bStartPaused : 1;                                         // 0x00F4(0x0004) (Edit)
	unsigned long                                      bEnableGammaCorrection : 1;                               // 0x00F4(0x0004)
	unsigned long                                      bDisplayWithHudOff : 1;                                   // 0x00F4(0x0004) (Edit)
	TEnumAsByte<EGFxRenderTextureMode>                 RenderTextureMode;                                        // 0x00F8(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00F9(0x0003) MISSED OFFSET
	class UTextureRenderTarget2D*                      RenderTexture;                                            // 0x00FC(0x0004) (Edit)
	TArray<struct FName>                               CaptureKeys;                                              // 0x0100(0x000C) (Edit, NeedCtorLink)
	TArray<struct FName>                               FocusIgnoreKeys;                                          // 0x010C(0x000C) (Edit, NeedCtorLink)
...
public:
	class UGFxMoviePlayer*                             Movie;                                                    // 0x00E8(0x0004)
	TArray<struct FName>                               CaptureKeys;                                              // 0x00EC(0x000C) (Edit, NeedCtorLink)
...
{
public:
	class USwfMovie*                                   Movie;                                                    // 0x0100(0x0004) (Edit)
	struct FString                                     FSCommand;                                                // 0x0104(0x000C) (Edit, NeedCtorLink)
	class UGFxFSCmdHandler_Kismet*                     Handler;                                                  // 0x0110(0x0004)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class GFxUI.GFxDataStoreSubscriber");
		return ptr;
	}
