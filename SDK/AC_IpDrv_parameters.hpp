...
struct UMeshBeaconClient_DebugRender_Params
{
	class UCanvas*                                     Canvas;                                                   // (Parm)
};

// Function IpDrv.MeshBeaconClient.DumpInfo
struct UMeshBeaconClient_DumpInfo_Params
{
};
...
struct UMeshBeaconHost_DebugRender_Params
{
	class UCanvas*                                     Canvas;                                                   // (Parm)
...
struct UMeshBeaconHost_DumpConnections_Params
{
};
...
struct UPartyBeaconHost_DumpReservations_Params
{
};
