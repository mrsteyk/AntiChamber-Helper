...
struct FGFxDataStoreBinding
{
	...
	TScriptInterface<class UUIListElementProvider>     ListDataProvider;                                         // 0x007C(0x0008) (Const, Transient)
...
struct FEventData
{
	class UGFxObject*                                  Target;                                                   // 0x0000(0x0004)
	struct FString                                     Type;                                                     // 0x0004(0x000C) (NeedCtorLink)
	int                                                Data;                                                     // 0x0010(0x0004)
	int                                                mouseIndex;                                               // 0x0014(0x0004)
	int                                                Button;                                                   // 0x0018(0x0004)
	int                                                Index;                                                    // 0x001C(0x0004)
	int                                                lastIndex;                                                // 0x0020(0x0004)
};
